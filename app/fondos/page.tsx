  ...
  return (
    <Tablero nombre={sesion.entidadNombre} nivel={sesion.nivel} activo="fondos">
      <main>
        ...
        <p className="panel">
          Los fondos marcados como <strong>disponibles</strong> son los que {sesion.entidadNombre}{" "}
          puede declarar como origen de un aporte. Los demas existen y se consultan, pero los
          inscribe la entidad a la que corresponden: un municipio no gasta del fondo nacional.
        </p>
        ...
        <p className="discreto">
          La Ley 1523 de 2012 obliga a que cada nivel tenga su propio fondo de gestion del riesgo:
          el nacional en el articulo 47 y los territoriales en el 54, como cuentas especiales con
          autonomia tecnica y financiera. Los fondos creados por la emergencia economica de agosto
          de 2026 estan anunciados pero su reglamentacion puede cambiar: hay que verificarlos antes
          del piloto. Detalle y fuentes en{" "}
