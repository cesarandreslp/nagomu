    ...
    <Tablero nombre={sesion.entidadNombre} nivel={sesion.nivel} activo="obras">
      <main>
        ...
        <p className="discreto">
          Estado actual: {ETIQUETA_ESTADO[obra.estado]}. El costo de una obra no existe hasta que un
          estudio lo determina; la cotizacion de los estudios, en cambio, se conoce antes. Son dos
          cifras distintas.
        </p>
        ...
        {obra.estado === "IDENTIFICADO" ? (
          <p className="discreto">
            Todavia no. Primero hay que registrar la cotizacion de los estudios: el valor de la obra
            sale del estudio, no de una estimacion.
          </p>
        ) : (
          <form action={registrarCostoDeEstudio}>
            ...
            <label>
              ...
              <input
                ...
                required
                maxLength={200}
                placeholder="Firma o profesional que lo elaboro"
              />
            </label>
            <label>
              ...
              <span className="discreto">
                Sin respaldo documental la cifra no es auditable, y esta obra va a repartir plata
                publica.
              </span>
            </label>
