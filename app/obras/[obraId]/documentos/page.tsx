...
import { ETIQUETA_DOCUMENTO, TAMANO_MAXIMO_BYTES, formatearTamano } from "@/lib/documentos";
    ...
    <Tablero nombre={sesion.entidadNombre} nivel={sesion.nivel} activo="obras">
      <main>
        ...
        <p className="discreto">
          Fotografias del daño, cotizaciones, estudios, avances y actas. De cada archivo se guarda
          su huella digital, asi que si alguien lo reemplaza despues de presentado, se nota.
        </p>
        ...
        {!hayAlmacenamiento ? (
          <p className="error">
            El almacenamiento de documentos todavia no esta configurado: falta crear el store de
            Vercel Blob en el proyecto. Hasta entonces no se pueden adjuntar archivos.
          </p>
        ) : null}
          ...
          <form action={adjuntarDocumento}>
            ...
            <label>
              ...
              <input
                name="nombre"
                maxLength={200}
                placeholder="Cubierta del ala norte, vista desde el patio"
              />
            </label>
            <label>
              <span>Archivo</span>
              ...
              <span className="discreto">
                PDF, JPG, PNG o WEBP. Maximo {formatearTamano(TAMANO_MAXIMO_BYTES)}. Las fotografias
                deben documentar el daño, no a las personas.
              </span>
            </label>
        ...
        <p className="discreto">
          ...
          trazabilidad, saber quien consulto el estudio que fijo el costo de una obra es parte del
          punto.
        </p>
      </main>
    </Tablero>
