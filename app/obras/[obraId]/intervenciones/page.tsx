...
export default async function Intervenciones({
  ...
  return (
    <main>
      ...
      <p className="discreto">
        Cuando una empresa, fundacion, voluntariado o persona ejecuta parte de la obra por
        su cuenta. Es el mecanismo de obras por impuestos y de cualquier ayuda en especie:
        no entra plata a una caja, deja de haber alcance que financiar.
      </p>
      <p className="discreto">
        <strong>El valor solo cuenta como ejecutado cuando el municipio recibe a
        satisfaccion.</strong>{" "}
        Sin ese freno cualquiera declara que arreglo la escuela, la brecha se cierra sola en
        pantalla y nadie reviso nada. Si una verificacion sale mal y se suspende, la brecha
        se reabre.
      </p>
        ...
        <>
          ...
          <form action={solicitarIntervencion}>
            ...
            <label>
              ...
              <input name="actorNombre" required maxLength={200} placeholder="Constructora del Valle SAS" />
            </label>
            <label>
            ...
            <label>
              ...
              <textarea name="alcance" required rows={3} maxLength={1000} placeholder="Reconstruccion de la cubierta del bloque de aulas" />
            </label>
            <label>
              <span>Valor equivalente</span>
              <input name="valorEquivalente" inputMode="decimal" required placeholder="400000000" />
              <span className="discreto">
                Cuanto deja de haber que financiar si se ejecuta. Es lo que se descuenta de
                la brecha, asi que merece el mismo cuidado que un contrato.
              </span>
            </label>
            <label>
            ...
            <label>
              ...
              <span className="discreto">
                Un tercero que arreglo el puente sin pedir permiso se puede registrar
                despues, pero queda marcado. Ni se premia ni se borra.
              </span>
            </label>
        ...
        obra.intervenciones.map((i) => {
          ...
          return (
            <section key={i.id}>
              ...
              {vencida ? (
                <p className="error">
                  El plazo comprometido vencio y la intervencion no se ha recibido. No se
                  cierra sola: la decision es del municipio.
                </p>
              ) : null}
